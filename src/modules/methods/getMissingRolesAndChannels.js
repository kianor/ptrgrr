    ...
    return new Promise(async resolve => {
        ...
        try {
            ...
            mergedCategories = mergedCategories.filter(category => {
                return !Utils.findChannel(category.name, guild, 'GUILD_CATEGORY', false);
            });
            mergedTextChannels = mergedTextChannels.filter(channel => {
                return !Utils.findChannel(channel.name, guild, 'GUILD_TEXT', false);
            });
            mergedVoiceChannels = mergedVoiceChannels.filter(channel => {
                return !Utils.findChannel(channel.name, guild, 'GUILD_VOICE', false);
            });
