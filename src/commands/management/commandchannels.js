            ...
            if (!type) {
                ...
                let getEmbed = () => {
                    ...
                    return Embed({
                        ...
                        description: global ? (usingGlobalSettings ? lang.ManagementModule.Commands.CommandChannels.Manager.Description[0] : lang.ManagementModule.Commands.CommandChannels.Manager.Description[1]) : undefined,
                        fields: [
                            {
