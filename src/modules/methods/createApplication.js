                ...
                if (settings.DeleteEmbedsAndSendAnswers) {
                    ...
                    applicationChannel.send(embed).catch(() => {
                        applicationChannel.send(Embed({
                            ...
                            fields: [{ name: lang.TicketModule.Commands.Apply.Embeds.Answers.Field[0], value: `${member} (${member.user.id})` }, { name: lang.TicketModule.Commands.Apply.Embeds.Answers.Field[1].Name, value: lang.TicketModule.Commands.Apply.Embeds.Answers.Field[1].Value.replace(/{url}/g, Haste) }]
                        }));
                    });
                }
