    ...
    if (interaction.isCommand()) {
        ...
        if (id == "verification_button") {
            ...
            if (id == "reactfor_ticket") {
                require("../modules/methods/createTicket")(bot, [], interaction.member, interaction.channel, true, 5000);
            ...
            if (customButton) {
                ...
                if (logs) logs.send(Embed({
                    author: lang.Logs.CustomButtonUsed.Author,
                    description: lang.Logs.CustomButtonUsed.Description
                        .replace(/{id}/g, id)
                        ...
                        .replace(/{actions}/g, actions && actions.length ? lang.Logs.CustomButtonUsed.Actions.replace(/{actions}/g, results.filter(r => r).map((r, i) => {
                            let a = actions[i];
