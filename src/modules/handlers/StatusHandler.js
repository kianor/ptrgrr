...
module.exports = async (bot) => {
    ...
    if (!variables.config.ActivityCycling.Enabled) {
        setInterval(async () => {
            ...
            bot.user.setActivity(Utils.getStatusPlaceholders(botStatus.activity.replace("https://", "")), { type: botStatus.type, url: botStatus.type.toUpperCase() == "STREAMING" ? botStatus.activity : undefined });
        }, 60 * 1000);
    }
